...
const ChallengeLayout = ({ children }) => {
    ...
    return (
            <div className="flex mt-[100px] gap-4">
                <div className=" hidden md:flex md:w-[20%] max-md:ml-0 max-md:w-full h-fit">
                    <div className="flex flex-col items-start gap-2 py-2 px-0 w-full rounded-[0.625rem] bg-white  border border-solid shadow-sm border-neutral-900 border-opacity-10 ">
                        ...
                        <Link to="/home" className="nav-content-bttn open-font">
                            <div className="flex justify-center items-center gap-4 py-2 px-6 " >
                                ...
                                <div className="text-[#1d1e21] font-['Sora'] text-base">Acceuil</div>
                            </div></Link>
                        ...
                        <Link to={`/profile/${id}`} className="nav-content-bttn open-font">
                            <div className="flex justify-center items-center gap-4 py-2 px-6">
                                ...
                                <div className="text-[#1d1e21] font-['Sora'] text-base font-base">Profil</div>
                            </div> </Link>
                        ...
                        {shouldShowAgentItem && (
                            ...
                            ><div className="flex justify-center items-center gap-4 py-2 px-6">
                                    ...
                                    <div className="text-[#1d1e21] font-['Sora'] text-base font-base">Agents</div>
                                </div>                      </Link>
                        )}
                        {shouldShowForProfile && (
                            ...
                            ><div className="flex justify-center items-center gap-4 py-2 px-6">
                                    ...
                                    <div className="text-[#1d1e21] font-['Sora'] text-base font-base ">Joueur</div>
                                </div>
                            </Link>
                        )}
                        <div className="w-full h-[0.3px] opacity-[0.2] bg-[#a3a3a4]" />
                        ...
                        <div className="flex justify-between items-center py-2 px-6 w-[19.875rem]">
                            <div className="flex justify-center items-center gap-4">
                                ...
                                <div className="text-[#1d1e21] font-['Sora'] text-base font-base">Camps</div>
                            </div>
                        </div>
                    </div>
                </div>
