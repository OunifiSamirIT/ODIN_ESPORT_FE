            ...
            <div className="flex flex-col md:flex-row gap-x-5 gap-y-2  w-full    mt-[100px]">
                ...
                <div className="flex-col w-full h-max">
                    ...
                    {tab === 'parametre' && <div className="flex justify-end">
                        <button onClick={()=> setDeleteModal(true)} className="mt-4 flex gap-2 justify-center px-8 py-2 text-base font-medium border-2 border-solid border-red-600 rounded-[30px] text-red-600">
