...
function Settings ({ setAuthStatus }) {
                                    ...
                                    <div className="card-body p-lg-5 p-4 w-100 border-0">
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <h4 className="mb-4 font-xxl fw-700 mont-font mb-lg-5 font-md-xs">Settings</h4>
                                                ...
                                                <ul className="list-inline">
                                                    ...
                                                    <button onClick={handleLogout} className="pt-2 pb-2 d-flex align-items-center">
