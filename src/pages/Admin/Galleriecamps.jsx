                    ...
                    <div className="middle-sidebar-bottom">
                        <div className="middle-sidebar-left pe-0">
                            ...
                            <div className="col-xl-12">
                                    ...
                                    <Link to="/admin/albumcamps/create" className="font-xsssss fw-700 ps-3 pe-3 lh-32 float-right mt-4 mb-4 text-uppercase rounded-3 ls-2 bg-info d-inline-block text-white me-1">Create New Camps</Link>
                                </div>
                                <div className="col-xl-12">
                                    ...
                                    <div className="row ps-2 pe-1">
                                        ...
                                        <div key={index} className="col-md-6 col-sm-6 pe-2 ps-2">
                                            <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-0 mt-2">
                                                <div className="card-body position-relative h200 bg-image-cover bg-image-center cover" style={{backgroundImage: `url(${(value.ImagesAlbumcamps[0]?.image_url)})`}}></div>
