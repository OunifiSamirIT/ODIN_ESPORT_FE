                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="flex gap-2 justify-between mt-4 max-md:flex-wrap max-md:max-w-full">
                    <div className="flex gap-2 justify-between">
                      ...
                      <button
                    type="submit"
                    className="justify-center text-center items-center px-10 py-2  text-base font-medium text-white whitespace-nowrap bg-blue-600 rounded-[30px] max-md:px-5 max-md:max-w-full"
                  >
                    Se connecter
                  </button>
                      </div>
                    ...
                    <Link
                      to="/forgot"
                      className="grow text-base font-medium py-2 text-blue-600 underline whitespace-nowrap"
                    >
                      Mot de pass oublier ?
                    </Link>
                  </div>
