    ...
    try {
      ...
      if (response.ok) {
        ...
        if (errorData.message.includes("Email")) {
          ...
          setErrorMessage(errorData.message); // Set the backend error message
                        ...
                        <div className="flex gap-4 justify-between mt-2 text-base">
                          ...
                          <div style={{ position: "relative", marginTop: "5px" }}>
                            <input
                              ...
                              className={`form-control grow justify-center w-full gap-2 items-start py-2.5 pl-1 border-solid bg-zinc-100 border-[0.5px] border-neutral-200 rounded-[30px] max-md:pr-2 ${inputErrors["numWSup"] ? "is-invalid" : ""
                                }`}
                        ...
                        <div className="flex gap-4  mt-2 text-base ">
                          ...
                          <div style={{ position: "relative", marginTop: "5px" }}>
                            <input
                              ...
                              className={` form-control grow justify-center w-full gap-2 items-start py-2.5 pl-1 ml-1 border-solid bg-zinc-100 border-[0.5px] border-neutral-200 rounded-[30px] max-md:pr-2 ${inputErrors["tel"] ? "is-invalid" : ""
                                }`}
                            />
                          </div>
                        </div>
            ...
            <div>
              {formData.profil === "player" && (
                <div className="flex flex-col items-center pb-12 bg-gray-200">
                  ...
                  <div className="flex flex-wrap gap-y-8 justify-center content-start items-center self-stretch px-16 mt-8 w-full max-md:px-5 max-md:max-w-full">
                    <div className="flex flex-col w-full max-w-[1184px] max-md:max-w-full">
                      <div className="flex gap-5 justify-between whitespace-nowrap text-zinc-900 max-md:flex-wrap max-md:max-w-full">
                        <div className="flex flex-col flex-1">
                          <div className="flex gap-4 justify-between px-4 text-lg">
                            <img
                              loading="lazy"
