    ...
    useEffect(() => {
        ...
        const fetchComments = async () => {
            try {
                ...
                console.log("kkkkkkkkkkkkkkk", comments)
            } catch (error) {
        ...
        return (
            <Fragment> 
              ...
              <div className='flex w-full h-full items-center justify-center'>
                ...
                </div>                                    <Postview id="32" postvideo="" postimage="post.png" avater="user.png" user="Surfiya Zakir" time="22 min ago" des="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus." />
