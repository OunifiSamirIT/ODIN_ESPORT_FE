                    ...
                    <div key={index} className="col-md-3 col-sm-4 pe-2 ps-2">
                      <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                        <div className="card-body d-block w-100 ps-3 pe-3 pb-2 text-center">
                          <figure className="overflow-hidden avatar ms-auto me-auto mb-0 position-relative w65 z-index-1">
                            <img
                              src={value?.image}
                              alt="avater"
                              className="float-right w-30 p-0 bg-white rounded-full  shadow-xss"
                            />
                          </figure>
                        ...
                        <div className="card-body d-flex align-items-center pt-0 ps-4  pe-4 pb-4">
                          <a
                            href="/defaultmember"
                            className="grow justify-center  py-2 mr-3 text-white text-center bg-blue-600 rounded-[30px] max-md:px-3"
                          >
                            Accepter
                          </a>
                          <a
                            href="/defaultmember"
                            className="grow justify-center  text-white py-2 text-center bg-orange-500 rounded-[30px] max-md:px-3"
                          >
                            Supprimer
                          </a>
                        </div>
