...
const Agent = ({ userInfo }) => {
    ...
    return (
        ...
        <>
          {  userInfo.agent.typeresponsable === 'club' &&             <div className="flex flex-col flex-wrap grow gap-y-6 justify-between content-start w-full bg-white rounded-xl max-md:pl-5 max-md:mt-6 max-md:max-w-full">
                    ...
                    <div className="mt-6 mr-4 max-md:mr-2.5 max-md:max-w-full flex-col md:flex-row flex gap-4 flex-wrap">
                         <div className="lg:flex-1 w-full">
                            <div className="flex gap-4 justify-between px-4 whitespace-nowrap">
                                ...
                                <div className="grow text-lg">Nombre de joueurs</div>
                            </div>
                        ...
                        <div className="lg:flex-1 w-full">
                            <div className="flex gap-4 justify-between px-4">
                                ...
                                />
                                <div className="grow text-lg">Nombre de transferts effectués</div>
                            </div>
                            <input {...register('club')} name='club' type='number' className={`form-control w-full justify-center items-start py-3.5 pr-16 pl-4 mt-2 text-base border border-solid border-[color:var(--black-100-e-5-e-5-e-5,#E5E5E5)] rounded-[30px] max-md:pr-5 ${errors.club ? 'is-invalid !border-red-500' : ''}`} />
            ...
            {  userInfo.agent.typeresponsable === 'player' &&             <div className="flex flex-col flex-wrap grow gap-y-6 justify-between content-start w-full bg-white rounded-xl max-md:pl-5 max-md:mt-6 max-md:max-w-full">
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-wrap grow gap-y-6 justify-between content-start w-full bg-white rounded-xl max-md:pl-5 max-md:mt-6 max-md:max-w-full">
                    <div className="mt-6 mr-4 max-md:mr-2.5 max-md:max-w-full flex-col md:flex-row flex gap-4 flex-wrap">
                         <div className="lg:flex-1 w-full">
                            <div className="flex gap-4 justify-between px-4 whitespace-nowrap">
