                    ...
                    <div className="mt-6  max-md:max-w-full flex-col md:flex-row flex gap-4 flex-wrap">
                        <div className="lg:flex-1 w-full">
                            ...
                            <select
                                name="engagement"
                                {...register('engagement')}
                                className={`form-control w-full justify-center items-start py-3.5 pr-16 pl-4 mt-2 text-base border border-solid border-[color:var(--black-100-e-5-e-5-e-5,#E5E5E5)] rounded-[30px] max-md:pr-5 ${errors.club ? 'is-invalid !border-red-500' : ''}`}
                            >
                    ...
                    <div className="flex flex-wrap gap-2   text-lg text-blue-600 max-md:flex-wrap max-md:pr-5 max-md:mr-2.5 max-md:max-w-full">
                        ...
                        <div className="form-group icon-input  mb-3">
                            {skillsList.map((skill, index) => (
                                <div key={skill} className="form-check rounded-[30px] pl-0  form-check-inline me-2 mb-2">
                                    <input
                                        type="checkbox"
                                        id={'skill' + index}
                        ...
                        {selectedSkills.length >= 10 && <span className="invalid-feedback block py-2 px-2">{
                              getTranslation(
