            ...
            <div className="flex flex-col flex-wrap grow  content-start w-full bg-white rounded-xl w-full">
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-wrap grow gap-y-6 justify-between content-start  w-full bg-white rounded-xl">
                        ...
                        <div className="lg:flex-1 w-full">
                            <div className="flex gap-2 justify-between px-4">
                                <img
                                    ...
                                    className="my-auto w-5 aspect-square ml-[-22px]"
                                />
                    ...
                    <div className=" md:w-1/2 pr-3  max-md:mr-2.5 max-md:max-w-full flex-col md:flex-row flex gap-4 flex-wrap items-center items-baseline">
                        <div className="lg:flex-1 w-full">
                            <div className="flex gap-2 justify-between items-center ml-[-22px] px-4">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <select
                                ...
                                className={`form-control appearance-none justify-center items-start py-3.5 pr-16 pl-4 mt-2 scale-x-[1.05] translate-x-1 text-base border border-solid border-[color:var(--black-100-e-5-e-5-e-5,#E5E5E5)] rounded-[30px] max-md:pr-5 w-full ${errors.footballTactic ? 'is-invalid !border-red-500' : ''}`}
                            >
                    ...
                    <div className="mr-4 max-md:mr-2.5 max-md:max-w-full flex-col md:flex-row flex gap-4 flex-wrap items-center items-baseline">
                        <div className="lg:flex-1 w-full">
                            <div className="flex gap-2 justify-between px-4 items-center  whitespace-nowrap">
                                <svg width="20" className="ml-[-22px]" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="lg:flex-1 w-full">
                            <div className="flex gap-2 justify-between px-4 items-center  text-lg">
                                <img
                                    ...
                                    className="my-auto w-5 ml-[-22px] aspect-square"
                                />
                                <div className="flex-auto">Compétences</div>
                            </div>
                        </div>

                        <div className="flex flex-wrap gap-2   mr-3 text-lg text-blue-600">
                            <div className="form-group icon-input  mb-3">
                                {skillsList.map((skill, index) => (
                                    <div key={skill} className="form-check rounded-[30px] form-check-inline pl-0 me-2 mb-2">
                                        ...
                                        >
                                            <div className="text-[15px] md:text-[18px] font-light"> {skill} {selectedSkills.includes(skill) ? <span className="pl-2">-</span> : <span className="pl-2">+</span>}  </div>
                                        </label>
                                    </div>
                                ))}
                    ...
                    <div className="flex  justify-between py-2 mt-[-16px] mr-4 w-full text-base font-medium flex-nowrap">
                        <div className="flex gap-2  items-center justify-center mx-2  px-4 py-2 text-blue-600 border-2 border-solid border-[color:var(--Accent,#2E71EB)] rounded-[30px] max-md:px-5">
                            <img
                                loading="lazy"
                                src="https://cdn.builder.io/api/v1/image/assets/TEMP/9e237a106a6aae9aaedb87131a5b6a9cefc6631b6b0b800569f8639d3cbb6941?"
                                className="w-5 aspect-square"
                            />
                            <a onClick={resetForm} className="">Annuler</a>
                        </div>
                        <div className="flex gap-2 flex items-center justify-center px-4 py-2 mx-2 text-white bg-blue-600 rounded-[30px] max-md:px-5">
                            <img
                                loading="lazy"
