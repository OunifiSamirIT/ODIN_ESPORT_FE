  ...
  return (
    <>
      <div className="flex flex-col p-8 bg-white rounded-[10px] border border-solid border-neutral-200 text-zinc-900 max-md:px-5">
        ...
        <StatBar
          exercice={"vitesse"}
          value={vitesse?.points ? vitesse?.points : 0}
        />
        <StatBar
          exercice={"saut"}
          value={saut?.totalPoints ? saut?.totalPoints : 0}
        />
        <StatBar
          exercice={"Agilité"}
          value={agilite?.data?.total_score ? agilite?.data?.total_score : 0}
        />
        <StatBar exercice={"Jonglage"} value={jonglage ?? 0} />
        <StatBar
          exercice={"Conduite de balle"}
          value={isNaN(conduit) ? 0 : conduit}
        />
