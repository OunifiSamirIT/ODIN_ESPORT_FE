              ...
              <form onSubmit={handleSubmit(onSubmit)} className="max-w-md w-full">
                ...
                <div className="flex gap-4 justify-between px-4 mt-4 text-lg max-md:flex-wrap max-md:max-w-full">
                  <img
                    ...
                    className="self-start w-5 aspect-square"
                  />
                  <div className="grow max-md:max-w-full">Confirmer votre mot de passe</div>
                </div>
                <div>
                  <input
                ...
                {confirmPassword !== getValues("password") && errMsg && ( // Display error message when passwords don't match
                  <span role="alert" className="text-sm text-[#f64949fe] mt-0.5">
                    {errMsg.message}
                  </span>
                )}
