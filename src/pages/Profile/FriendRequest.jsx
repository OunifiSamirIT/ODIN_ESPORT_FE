...
const FriendRequest = () => {
    ...
    const fetchFriendRequest = async () => {
        const response = await fetch(`http://localhost:5000/api/user/${storedUserData.id}/FriendRequest`);
            ...
            <div className="hidden md:col-span-3 md:block">
                <div className="flex flex-col gap-y-4 justify-start py-4 mx-auto w-full bg-white rounded-[10px] px-4">
                    ...
                    <div className="flex gap-4  px-6 py-2 max-md:px- items-center">
                        ...
                        <div className="my-auto text-xl font-medium text-zinc-900">Profil</div>
                    </div>
