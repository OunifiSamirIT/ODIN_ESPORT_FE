...
const Social = ({ userInfo }) => {
  return (
    <div div className="mt-4 max-w-xl  flex gap-4 justify-between">
      {userInfo?.user.liensSM && (
        <a
          target="_blank"
          href={`https://www.instagram.com/${userInfo?.user.liensSM}`}
        >
          <svg
            width="25"
            height="25"
      ...
      {userInfo?.user.tiktok ? (
        <a
          target="_blank"
          href={`https://www.tiktok.com/${userInfo?.user.tiktok}`}
        >
          <svg
            width="25"
            height="25"
      ...
      {userInfo?.user.linkedin ? (
        <a
          target="_blank"
          href={`https://www.linkedin.com/in/${userInfo?.user.linkedin}`}
        >
          <svg
            width="25"
            height="25"
      ...
      {userInfo?.user.fb ? (
        <a
          target="_blank"
          href={`https://www.facebook.com/${userInfo?.user.fb}`}
        >
          <svg
            width="25"
            height="25"
      ...
      {userInfo?.user.x ? (
        <a target="_blank" href={`https://www.x.com/${userInfo?.user.x}`}>
          <svg
            width="25"
            height="25"
            viewBox="0 0 25 25"
