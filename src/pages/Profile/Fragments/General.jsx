...
const General = ({ userInfo }) => {
  ...
  console.log('player info from ', isOwner, userInfo?.user.id, id)
    ...
    <>
      <div className="flex flex-col items-center px-4 py-6 bg-white rounded-[10px]">
        ...
        {userInfo?.user.profil === 'agent' &&  
            userInfo?.agent?.skills.split(',').map((item) => {
            return (<div className="grow justify-center px-4 py-2 border-2 border-blue-600 border-solid rounded-[30px]">
              {item}
            </div>)
          })} 
          {userInfo?.user.profil === 'scout' &&  
            userInfo?.scout?.skillsscout.split(',').map((item) => {
            return (<div className="grow justify-center px-4 py-2 border-2 border-blue-600 border-solid rounded-[30px]">
              {item}
            </div>)
          })} 
          {userInfo?.user.profil === 'other' &&  
            userInfo?.other.skillsAutre.split(',').map((item) => {
            return (<div className="grow justify-center px-4 py-2 border-2 border-blue-600 border-solid rounded-[30px]">
              {item}
            </div>)
          })} 
