        ...
        <div className="grid grid-cols-12 gap-4 mt-[100px]">
            <div className="hidden md:col-span-3 md:block">
                <div className="flex flex-col w-[24%] max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col items-start gap-2 py-2 px-0 w-[19.875rem] rounded-[0.625rem] bg-white  border border-solid shadow-sm border-neutral-900 border-opacity-10 ">
            ...
            <div className="w-full bg-red-500  flex flex-col px-4 md:px-0 ">
