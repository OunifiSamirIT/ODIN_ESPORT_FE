...
const FriendList = () => {
  ...
  const getNationalityFlagFromCountryName = (nationality) => {
    const country = paysAllInfo.find(
      (country) => country.nationalite == nationality
    );
    return country ? country.iso["alpha-2"].toLowerCase() : null;
  };
            ...
            {FriendRequest.map((item) => {
              return (
                <div className="col-span-1">
                  {item.receiver && (
                    <div className="flex flex-col grow p-4 mx-auto w-full text-xs bg-white rounded-[10px] text-zinc-900 max-md:px-5">
                      <img
                        loading="lazy"
                        src={
                          item.receiver?.image
                      ...
                      <div className="flex gap-4 justify-between mt-4 w-full">
                        ...
                        <div className="my-auto font-medium">
                          ...
                          {item.receiver.profil == "other"
                            ? item?.receiver?.other_user[0]?.profession
                            : ""}
                        </div>
                      </div>
                      <div className="flex gap-4 justify-between mt-4 w-full whitespace-nowrap">
                        ...
                        <div className="flex font-medium">
                          <div className="flex font-medium whitespace-nowrap">
                            <span
                              className={`flag-icon flag-icon-${getNationalityFlagFromCountryName(
                                item.receiver?.nationality
                              )}`}
                        ...
                        <div className="flex font-medium whitespace-nowrap">
                          <span
                            className={`flag-icon flag-icon-${getCountryFlagFromCountryName(
                              item.receiver?.countryresidence
                            )}`}
                            style={{ marginRight: "8px", width: "25px" }}
                          ></span>
                  ...
                  {item.sender && (
                    <div className="flex flex-col grow p-6 mx-auto w-full text-xs bg-white rounded-[10px] text-zinc-900 max-md:px-5">
                      <img
                        loading="lazy"
                        src={
                          item.sender?.image ? item?.sender.image : Placeholder
                        }
                        className="self-center max-w-full rounded-full aspect-square w-[120px]"
                      />
                      <div className="self-center mt-4 text-xl font-medium text-black">
                      ...
                      <div className="flex gap-4 justify-between mt-4 w-full">
                        ...
                        <div className="my-auto font-medium">
                          ...
                          {item.sender.profil == "other"
                            ? item?.sender?.other_user[0]?.profession
                            : ""}
                        </div>
                      </div>
                      <div className="flex gap-4 justify-between mt-4 w-full whitespace-nowrap">
