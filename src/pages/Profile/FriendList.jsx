...
const FriendList = () => {
    ...
    const getCountryFlagFromCountryName = (countryName) => {
        const country = paysAllInfo.find(country => country.name == countryName.toLowerCase());
        return country ? country.iso["alpha-2"].toLowerCase() : null;
    }
    const getNationalityFlagFromCountryName = (nationality) => {
        const country = paysAllInfo.find(country => country.nationalite == nationality);
        return country ? country.iso["alpha-2"].toLowerCase() : null;
    }

    return (<HomeLayout>
        <div className="grid grid-cols-8 gap-4 mt-[100px]">
            <div className="hidden lg:col-span-2 md:block">
                {/* left menu */}
                <div className=" xs:hidden sm:hidden hidden  md:flex md:flex-col w-full max-md:ml-0 max-md:w-full">
            ...
            <div className="md:col-span-6 col-span-8 w-full  w-full flex flex-col  md:px-0 ">
                    ...
                    {FriendRequest.map((item) => {
                        return (
                            <div className="col-span-1">
                                {item.receiver && <div className="flex flex-col grow p-4 mx-auto w-full text-xs bg-white rounded-[10px] text-zinc-900 max-md:px-5">
                                    <img
                                        loading="lazy"
                                    ...
                                    <div className="flex gap-4 justify-between mt-4 w-full whitespace-nowrap">
                                        ...
                                        <div className="flex font-medium">
                                            <div className="flex font-medium whitespace-nowrap">
                                                <span
                                                    className={`flag-icon flag-icon-${getNationalityFlagFromCountryName(item.receiver?.nationality)}`}
                                ...
                                {item.sender && <div className="flex flex-col grow p-6 mx-auto w-full text-xs bg-white rounded-[10px] text-zinc-900 max-md:px-5">
                                    <img
                                        loading="lazy"
                                    ...
                                    <div className="flex gap-4 justify-between mt-4 w-full">
                                        ...
                                        <div className="my-auto font-medium">
                                            ...
                                            {item.sender.profil == 'other' ? item?.sender?.other_user[0]?.profession : ''}</div>
                                    </div>
                                    <div className="flex gap-4 justify-between mt-4 w-full whitespace-nowrap">
                                        <div className="flex gap-4 font-light">
                                            <img
                                        ...
                                        <div className="flex font-medium">
                                            ...
                                            <div className="flex font-medium whitespace-nowrap">
                                                <span
                                                    className={`flag-icon flag-icon-${getNationalityFlagFromCountryName(item.sender?.nationality)}`}
                                                    style={{ marginRight: "8px", width: "25px" }}
                                                ></span>
                                    ...
                                    <div className="flex gap-4 justify-between mt-4 w-full">
                                        ...
                                        <div className="flex font-medium whitespace-nowrap">
                                            <span
                                                className={`flag-icon flag-icon-${getCountryFlagFromCountryName(item.sender?.countryresidence)}`}
                                                style={{ marginRight: "8px", width: "25px" }}
                                            ></span>
                                    ...
                                    <div className="flex gap-2 justify-between mt-4 text-base font-medium text-white whitespace-nowrap">
                                        <Link to={`/profile/${item.sender.id}`} className="justify-center px-6 py-2 bg-blue-600 rounded-[30px] max-md:px-5">
