                    ...
                    <div className="middle-sidebar-bottom">
                        <div className="middle-sidebar-left pe-0">
                            ...
                            <div className="col-xl-12">
                                    ...
                                    {/* <Link to="/admin/album/create" className="font-xsssss fw-700 ps-3 pe-3 lh-32 float-right mt-4 mb-4 text-uppercase rounded-3 ls-2 bg-info d-inline-block text-white me-1">Create New Album</Link> */}
                                </div>
                                <div className="col-xl-12">
                                            ...
                                            <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-0 mt-2">
                                                ...
                                                <div className="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                                    ...
                                                    <span className="position-absolute right-15 top-0 d-flex align-items-center">
                                                        <a href={"/odingallery/view/" + value.id} className="text-center p-2 lh-24 w100 ms-1 ls-3 d-inline-block rounded-xl bg-current font-xsssss fw-700 ls-lg text-white">View</a>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
