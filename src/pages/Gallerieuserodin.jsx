  ...
  return (
    <>
      ...
      <div className="nav-header  md:ml-[40px] 2xl:ml-[120px] ">
        <nav className="navigation scroll-bar md:w-[24%]">
          <div className="container ps-0 pe-0  w-full">
            ...
            <div className="  flex flex-col px-10 items-start gap-4 py-4  w-full rounded-[0.625rem] bg-white  border border-solid shadow-sm border-neutral-900 border-opacity-10 ">
            <Link to="/home" className="nav-content-bttn open-font">
