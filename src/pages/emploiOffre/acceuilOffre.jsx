  ...
  <div className="flex justify-center items-center gap-4 py-2 px-6 " >
    <div className="flex justify-center items-center gap-2.5 p-2 rounded-full text-xl font-bold whitespace-nowrap text-zinc-900">
      <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M18.3299 4.77286V1.6701C18.3299 1.21019 17.9575 0.836926 17.4967 0.836926C17.036 0.836926 16.6635 1.21019 16.6635 1.6701V3.6414L12.3285 0.716116C10.913 -0.238705 9.0833 -0.238705 7.66773 0.716116L1.83549 4.65204C0.686538 5.42773 0 6.71832 0 8.10556V15.8341C0 18.1312 1.86882 20 4.16589 20H5.83224C6.29299 20 6.66542 19.6267 6.66542 19.1668V11.6682C6.66542 11.2091 7.03868 10.8351 7.49859 10.8351H12.4977C12.9576 10.8351 13.3308 11.2091 13.3308 11.6682V19.1668C13.3308 19.6267 13.7033 20 14.164 20H15.8304C18.1274 20 19.9963 18.1312 19.9963 15.8341V8.10556C19.9963 6.78831 19.3764 5.55771 18.3299 4.77286Z" fill="#1D1E21" />
      </svg>
    </div>
    <div className="text-[#1d1e21] font-['Sora'] text-xl font-medium leading-[normal]">Acceuil</div>
  </div>
  ...
  <div className="flex justify-between items-center py-2 px-6 w-[19.875rem]">
    ...
    <div className="scroll_right flex justify-center items-center p-2">
      <svg width={20} height={10} viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1.24782 0.0605469C1.57961 0.060839 1.8977 0.192876 2.13216 0.42763L8.53276 6.82823C8.72644 7.02196 8.95639 7.17564 9.20948 7.2805C9.46256 7.38535 9.73382 7.43931 10.0078 7.43931C10.2817 7.43931 10.553 7.38535 10.8061 7.2805C11.0591 7.17564 11.2891 7.02196 11.4828 6.82823L17.8792 0.435973C18.1152 0.208017 18.4313 0.0818804 18.7595 0.0847317C19.0876 0.087583 19.4014 0.219194 19.6335 0.451217C19.8655 0.683241 19.9971 0.997113 20 1.32523C20.0028 1.65335 19.8767 1.96946 19.6487 2.20548L13.2573 8.59774C12.3961 9.45724 11.2291 9.93997 10.0124 9.93997C8.79564 9.93997 7.62862 9.45724 6.76742 8.59774L0.366823 2.19714C0.191944 2.02237 0.0727501 1.79972 0.0242825 1.55729C-0.0241833 1.31485 0.000247955 1.06348 0.0944939 0.834916C0.188742 0.606349 0.348581 0.41082 0.553843 0.273003C0.759104 0.135187 1.00059 0.0612579 1.24782 0.0605469Z" fill="#1D1E21" />
      </svg>
    </div>
  </div>
  ...
  <div className="flex flex-col items-start gap-2">
    ...
    <div className="flex flex-col items-center gap-2.5 w-[19.875rem]">
      ...
      <div className="flex gap-5 text-lg text-neutral-900 max-md:flex-wrap">
        <img
          loading="lazy"
          srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/65debcbace93ddb33fd31d33cab875774eba41a40f0439117e185b1f52e7d180?apiKey=3852610df1e148bb99f71ca6c48f37ee&"
      ...
      <div className="mt-2 text-lg text-neutral-900 text-opacity-70 max-md:max-w-full">
        ...
        rejoindre notre équipe de football. En tant qu'Analyste de Performance,
        vous jouerez un rôle crucial dans l'amélioration des performances de
        notre équipe grâce à une analyse approfondie des aspects tactiques,
        techniques et statistiques des matches de football. Vous travaillerez en
        étroite collaboration avec les entraîneurs, les joueurs et les autres
        membres du personnel pour fournir des informations précieuses qui
        contribuent à la prise de décision stratégique et au développement des
        joueurs.
        <br />
        Responsabilités :<br />
        Analyser les séquences vidéo des matches pour identifier les tendances
        de performance et les indicateurs clés.
        <br />
        Collecter et interpréter les données pour cibler les domaines
        d'amélioration.
        <br />
        Scout les adversaires pour informer les stratégies de jeu.
        <br />
        Soutenir le développement des joueurs grâce aux retours et à l'analyse.
        <br />
        Présenter les résultats aux entraîneurs et aux joueurs.
        <br />
        Rester informé des avancées technologiques dans l'analyse de la
        performance.
        <br />
        Avantages :<br />
        ...
        <br />
        Accès à des installations et des ressources de premier ordre.
      </div>
      ...
      <div className="flex gap-2.5 justify-between pl-4 mt-2 w-full whitespace-nowrap rounded-xl border border-solid border-neutral-200 max-md:flex-wrap max-md:max-w-full">
        <div className="my-auto text-lg text-zinc-900">
          contact@linearcompany.com
        </div>
        <div className="flex gap-2 justify-center px-8 py-2 text-base font-medium text-white bg-blue-600 rounded-[30px] max-md:px-5">
          <img
            loading="lazy"
