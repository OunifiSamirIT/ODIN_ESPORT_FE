  ...
  return (
    <>
      ...
      <div className="flex flex-col pb-20  md:mt-20 bg-zinc-100">
        <div className="self-center mt-12 w-full max-w-[1344px] ">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[24%] max-md:ml-0 max-md:w-full">
              <div className="xs:hidden sm:hidden hidden  md:flex md:flex-col items-start gap-4 py-4 px-0 w-[19.875rem] rounded-[0.625rem] bg-white  border border-solid shadow-sm border-neutral-900 border-opacity-10 ">
