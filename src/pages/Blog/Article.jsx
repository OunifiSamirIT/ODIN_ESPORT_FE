...
const Article = () => {
    ...
    return (
        ...
        <div className="flex flex-col justify-center w-full bg-gray-200 max-h-fit">
            ...
            {article[0] && <div className=" px-4 flex flex-col items-center gap-y-32 w-full h-fit flex justify-center text-center">
                                ...
                                <div className="flex flex-col p-6 bg-white rounded-[10px] text-zinc-900 max-md:px-5 max-md:max-w-full">
                                    ...
                                    <div className="flex flex-wrap gap-1 py-2">
                                        {article[0]?.tags.split(',').map((e) => {
                                            return (<div className="justify-center self-start px-3 py-1.5 text-base font-medium text-white whitespace-nowrap bg-blue-600 rounded-md">
                                                {e}
                                            </div>)
                                        })}
                                    </div>
                                    ...
                                    <div className="text-left mt-4 font-sans" dangerouslySetInnerHTML={{ __html: JSON.parse(article[0]?.content) }} />
                                </div>
                                                ...
                                                <div className="flex flex-col py-2 mt-4">
                                                    <div className="flex gap-4 justify-between text-sm text-blue-600 max-md:mr-1">
                                                        {item?.tags.split(',').map((e) => {
                                                            return (<div className="flex-wrap justify-center px-4 py-1 rounded-2xl bg-blue-600 bg-opacity-10">
                                                                {e}
                                                            </div>)
                                                        })}
                                                    </div>
