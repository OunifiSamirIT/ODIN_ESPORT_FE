  ...
  return (
    <>
      <div className=" relative flex justify-end">
        ...
        />
        <div
          className={`hidden md:flex absolute  h-[60px] top-0 z-1 flex  gap-4 items-center pl-4 pr-[145px] bg-blue-600 rounded-[80px] max-md:flex-wrap  ${
            expanded
              ? "w-fit expand  pointer-events-auto"
              : "w-fit expand pointer-events-none"
          }`}
          style={{
            transition: ".3s",
