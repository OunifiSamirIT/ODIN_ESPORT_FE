...
const SlideMenu = ({
  ...
  const toggleExpand = () => {
    setExpanded(!expanded);
    setExpandedSlide(expanded);
    if (!expandedslide) {
      setExpandedSlide(false);
    }
    console.log(!expanded, "bbb");
  };
  ...
  return (
    <>
      {/* <div className="relative flex justify-end">
        ...
        />
        <div
          className={`hidden md:flex flex-col absolute top-[70px] w-48 right-0 z-1 gap-4 items-start p-4 bg-blue-600 rounded-[10px] transition-all ${
            expanded ? "opacity-100" : "opacity-0 pointer-events-none"
          }`}
        >
          <div className="flex gap-2 slideMenuBtn justify-start p-2 text-base font-medium text-white w-full">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/e13bde84fa9b2785556220b4a439b162b51401e76b4b6dbacca76198fd0f64c0?"
              className="w-5 aspect-square"
          ...
          <div className="flex gap-2 slideMenuBtn justify-start p-2 text-base font-medium text-white w-full">
            <img
              ...
              className="aspect-[0.75] w-[15px]"
            />
            <a className="hover:text-white" href={`/profile/${user?.id}`}>
              {getTranslation("Profile", "Profil")}
            </a>
          </div>
          <div className="flex justify-center items-center w-full">
            <div className="w-full border-t border-white"></div>
          ...
          <div className="flex gap-2 slideMenuBtn justify-start p-2 text-base font-medium text-white w-full">
            <img
              ...
              className="w-5 aspect-square"
            />
            <a className="hover:text-white" href={"/setting/personal"}>
              {getTranslation("Settings", "Paramètres")}
            </a>
          </div>
          <div className="flex justify-center items-center w-full">
            <div className="w-full border-t border-white"></div>
          </div>
          <div className="flex gap-2 ml-1 justify-start slideMenuBtn  text-base font-medium text-white w-full">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/3fb21d1ad3af303c8fe8ca3c06f84fa81ac2ef681719a85f8aae751c3eb5e1ef?"
              className="aspect-[1.49] w-[30px]"
            />
            <LanguageToggler hide={true} />
          </div>
          <div className="w-full border-t mr-10 border-white"></div>
          <div className="flex gap-2 slideMenuBtn justify-start p-2 text-base font-medium text-white w-full">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/7e89f8c7eb51a481e293bc932ceeb5782dea45f8469a1e16a1753ed7be9f6c3e?"
            ...
            <div className="grow" onClick={handleLogout}>
              {getTranslation("Log Out", "Déconnexion")}
            </div>
          </div>
        </div>
      </div> */}
      <div className="relative flex justify-end">
        ...
        />
        <div
          className={`hidden md:flex flex-col absolute top-[70px] w-48 right-0 z-1 gap-4 items-start p-4 bg-blue-600 rounded-[10px] ${
            expanded
              ? "animate-slideDown" // Classe d'animation Tailwind CSS
