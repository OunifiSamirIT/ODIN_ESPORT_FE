    ...
    return (
      <div className="nav-header bg-white shadow-xs border-0">
       <div className=" flex justify-between items-center w-full">
                ...
                <ul className="mb-1 top-content">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="ml-3">Challanges</span>
                    </Link>
                  </li>
                  <li>
                    <Link
        ...
        { Hamburger &&   <div className='mt-6 bg-gray-300 absolute top-[98px] left-0 z-0 py-4 md:hidden w-screen h-[800px] overflow-y-scroll'>
