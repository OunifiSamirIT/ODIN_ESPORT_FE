  ...
  const handleSearch = (event) => {
    ...
    if (searchString.trim() === "") {
      ...
      const filteredUsers = users
        .filter(
          (user) =>
            user.nom.toLowerCase().startsWith(searchString.toLowerCase()) ||
            user.nom.toLowerCase().includes(searchString.toLowerCase())
        )
          ...
          <div className="bg-zinc-100 fixed left-0 z-0 py-4 md:hidden w-screen h-screen overflow-y-scroll z-90">
            <div className="flex flex-col items-center pb-12 mx-auto w-full max-w-[480px]  overflow-hidden ">
              <div className="flex flex-col gap-y-4 items-center pb-12 mx-auto w-full max-w-[480px] h-[1000] ">
                ...
                <BurgerMenuLink Href={"/friends"} Title={"Demandes"} Svg={``}>
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    ...
                    >
                      ...
                      <g id="Layer_2" data-name="Layer 2">
                        <g id="Filled">
                          <path
                            class="cls-1"
                            d="M405.34,85.33H381.87A106.86,106.86,0,0,0,277.34,0H234.67A106.84,106.84,0,0,0,130.14,85.33H106.67A106.8,106.8,0,0,0,0,192v64H512V192A106.79,106.79,0,0,0,405.34,85.33Zm-230.75,0a64,64,0,0,1,60.08-42.67h42.67a64,64,0,0,1,60.07,42.67Z"
                          />
                          <path
                            class="cls-1"
                            d="M443.17,465.1H418.52a26,26,0,0,1-24.72-17.92l-7.61-23.44a25.94,25.94,0,0,1,9.44-29.12l19.94-14.48a25.93,25.93,0,0,1,30.56,0l19.94,14.48a25.93,25.93,0,0,1,9.44,29.07l-7.6,23.43A26,26,0,0,1,443.17,465.1Z"
                          />
                          <path
                            class="cls-1"
                            d="M485.34,465l8.36,0a107,107,0,0,1-42.8,36.76l4.83-15.05A31.11,31.11,0,0,1,485.34,465Z"
                          />
                          <path
                            class="cls-1"
                            d="M355.24,298.66h-77.9V320a21.34,21.34,0,0,1-42.67,0V298.66H0V405.33A106.8,106.8,0,0,0,106.67,512H314.36a145.88,145.88,0,0,1,40.88-213.34Z"
                          />
                          <path
                            class="cls-1"
                            d="M512,328.55a125,125,0,1,0,43.88,95.11A124.49,124.49,0,0,0,512,328.55Zm-3.65,62.06L512,378.82l4.43-14.31a103.45,103.45,0,0,1,18.14,53.37l-22.27-15.7a3,3,0,0,1-.3-.23A10.37,10.37,0,0,1,508.35,390.61Zm-50.46-67.45h-.08L437,338.3a10.4,10.4,0,0,1-12.23,0L404,323.16A100.73,100.73,0,0,1,457.89,323.16ZM345.27,364.52l8.07,26.09a10.37,10.37,0,0,1-3.94,11.57l-22.28,15.7A103.43,103.43,0,0,1,345.27,364.52ZM376.51,512a104.47,104.47,0,0,1-28.79-26.27l28.57.1a10.39,10.39,0,0,1,9.88,7.21l6.08,19,2.9,9A104.21,104.21,0,0,1,376.51,512Zm90,9,9-28a10.39,10.39,0,0,1,9.87-7.21l28.58-.1A104.22,104.22,0,0,1,466.55,521.05Zm59.66-56.16-32.51.1-8.36,0a31.11,31.11,0,0,0-29.61,21.68l-4.83,15.05-8,25a95.9,95.9,0,0,1-24.06,0L414,511.64l-8-24.95A31.13,31.13,0,0,0,376.35,465l-40.86-.12a103,103,0,0,1-6.86-22.63l32.75-23.08a31.12,31.12,0,0,0,11.84-34.72l-11.81-38.19a104.21,104.21,0,0,1,19.6-14l31.49,22.88a31.12,31.12,0,0,0,36.7,0l31.49-22.88a103.82,103.82,0,0,1,19.59,14l-11.8,38.19a31.12,31.12,0,0,0,11.83,34.72L510,426l23.1,16.28A102.73,102.73,0,0,1,526.21,464.89Z"
                          />
                          <path
                            class="cls-1"
                            d="M466.07,394.62l-19.94-14.48a25.93,25.93,0,0,0-30.56,0l-19.94,14.48a25.94,25.94,0,0,0-9.44,29.12l7.61,23.44a26,26,0,0,0,24.72,17.92h24.65a26,26,0,0,0,24.74-18l7.6-23.43A25.93,25.93,0,0,0,466.07,394.62Zm-10.34,22.64-7.61,23.44a5.2,5.2,0,0,1-4.95,3.6H418.52a5.22,5.22,0,0,1-4.94-3.6L406,417.25a5.21,5.21,0,0,1,1.89-5.82L427.79,397a5.22,5.22,0,0,1,6.12,0l19.94,14.48A5.22,5.22,0,0,1,455.73,417.26Z"
                          />
                        </g>
                      </g>
                    </svg>
