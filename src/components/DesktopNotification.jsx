...
export default function DesktopNotification({notificationData, popupNotificationIsHidden, setPopupNotificationHidden,setIsActive,deleteNotData, setnotificationData, NotificationService}) {
     // notification
...
if (!popupNotificationIsHidden) {
  ...
  return (
    <span className="max-sm:hidden md:flex notificationOuterContainer -translate-x-6 -translate-y-0">
    <div style={{
