...
import ChallengeSideBar from "./HomePage/ChallengeSideBar";
import EventSideBar from "./HomePage/EventSideBar";
...
export default function LeftMenu({
  ...
  return (
    <>
      ...
      >
        <div  className=" fixed xs:hidden sm:hidden hidden max-h-[82vh] hiddenScrollLeftMenu overflow-y-scroll overflow-x-hidden md:flex md:flex-col md:max-w-[23%] max-md:ml-0 max-md:w-full pr-1">
          <div style={dark_light_bg} className="  flex flex-col items-start gap-3 py-4 px-0 w-full rounded-[0.500rem]  border-0 shadow-sm border-neutral-900 border-opacity-10 ">
            <Link to="/home" className="nav-content-bttn open-font">
              <div style={dark_light_bg} className="flex justify-center items-center gap-4 py-2 px-6 ">
                <div style={dark_light_bg} className="flex justify-center items-center gap-2.5 p-2 rounded-full text-base font-bold whitespace-nowrap text-zinc-900">
                  <svg
                    width={20}
                    height={20}
                    viewBox="0 0 20 20"
                ...
                <div style={dark_light_bg} className="text-[#1d1e21] font-['Sora'] text-base font-medium leading-[normal]">
                  {getTranslation(
                    `Home`, // -----> Englais
                    `Acceuil` //  -----> Francais
                    //   ``,  //  -----> Turkey
            ...
            <div style={dark_light_bg} className="w-full h-[0.3px] opacity-[0.2] bg-[#a3a3a4] " />

            <Link to={`/profile/${id}`} className="nav-content-bttn open-font ">
              <div style={dark_light_bg} className="flex justify-center items-center gap-4 py-2 px-6">
                <div style={dark_light_bg} className="flex flex-col items-center gap-0.5 p-2">
                  <svg
                    width={11}
                    height={10}
                    viewBox="0 0 11 10"
            ...
            {shouldShowAgentItem && (
              <>
                ...
                >
                  {/* <div style={dark_light_bg} className="w-full h-[0.3px] opacity-[0.2] bg-[#a3a3a4]" /> */}
                  <div style={dark_light_bg} className="flex justify-center items-center gap-4 py-2 px-6">
                    <div style={dark_light_bg} className="flex justify-center items-center gap-2.5 p-2 rounded-full">
                      <svg
                        width={19}
                        height={20}
                        viewBox="0 0 19 20"
            ...
            <div
              ...
              className="flex gap-5 justify-between px-6 py-2   w-full text-base font-medium whitespace-nowrap text-zinc-900 max-md:px-5 cursor-pointer"
            >
              <div style={dark_light_bg} className="flex gap-4 justify-between px-2 py-1.5 ">
                <img style={dark_img} 
                  loading="lazy"
              ...
              <img style={dark_img} 
                ...
                className="shrink-0 my-auto w-3 aspect-[2] fill-zinc-900"
              />
            </div>
            {eventTogglerIsOpenned && (
              <>
                <div style={dark_light_bg} className="toggler mt-[-15px] ml-10px w-5">
                  <Link to="/defaultgroup">
                    <div style={dark_light_bg} className="flex gap-5 justify-between px-6 ml-5 py-2 w-full text-base font-medium whitespace-nowrap text-zinc-900 max-md:px-5 cursor-pointer">
                      <div style={dark_light_bg} className="flex gap-4 justify-between px-2 py-1.5 text-sm">
                        <svg
                          width="21"
                          height="20"
                          viewBox="0 0 21 20"
                  ...
                  <Link to="/challenges  ">
                    <div style={dark_light_bg} className="flex gap-5 justify-between px-6 py-2 ml-5 mt-2 w-full text-base font-medium whitespace-nowrap text-zinc-900 max-md:px-5 cursor-pointer">
                      <div style={dark_light_bg} className="flex gap-4 justify-between px-2 py-1.5 text-sm">
                        <svg
                          width="21"
                          height="20"
                  ...
                  <Link to="/defaultgroupEvents">
                    <div style={dark_light_bg} className="flex gap-5 justify-between px-6 ml-5 py-2 mt-2 w-full text-base font-medium whitespace-nowrap text-zinc-900 max-md:px-5 cursor-pointer">
                      <div style={dark_light_bg} className="flex gap-4 justify-between px-2 py-1.5 text-sm">
                        <img style={dark_img} 
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/2cf2e6080455aed54d848487194a6ca0fa5a1f12e5bf524b2f4def505c5924b9?apiKey=3852610df1e148bb99f71ca6c48f37ee&"
            ...
            <Link to="/homeoffre">
              <div style={dark_light_bg} className="flex gap-3 justify-between px-6  py-2 w-full text-base font-medium whitespace-nowrap text-zinc-900 max-md:px-5">
                <div style={dark_light_bg} className="flex gap-4 justify-between px-2 py-1.5">
                  {" "}
                  <img style={dark_img} 
                    loading="lazy"
